...
const { getAllGrammars, getGlobalGrammars, getGrammarById, togglePin, getCategories, createGrammar, updateGrammar, deleteGrammar, deleteCategory } = require('../controllers/grammarController');
const { authenticate } = require('../middleware/authMiddleware');

router.get('/', authenticate, getAllGrammars);
router.get('/global', getGlobalGrammars);
