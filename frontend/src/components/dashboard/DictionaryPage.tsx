        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2.5 rounded-lg bg-white border border-gray-300 transition hover:shadow-[0_0_3px_0_rgba(0,0,0,0.12)]"
            />
          </div>
          <button
      ...
      <div className="bg-white rounded-lg border border-gray-200 min-h-[500px] flex flex-col relative transition-all overflow-hidden">
        {loading ? (
          <div className="flex-1 flex flex-col items-center justify-center py-20">
            ...
            <p className="text-gray-500 text-sm font-medium animate-pulse uppercase tracking-wider">
              Kelime Çözümleniyor...
            </p>
          </div>
        ) : results ? (
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-full">
            {results.map((i, index) => (
              <div
                key={index}
                className="flex flex-col bg-gray-50 rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all duration-200"
              >
