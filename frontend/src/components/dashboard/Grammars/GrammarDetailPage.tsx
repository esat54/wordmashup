    ...
    <div className="max-w-7xl mx-auto space-y-5 antialiased text-slate-900">
      ...
      <div className="grid grid-cols-12 gap-5">
        <div className="col-span-12 lg:col-span-8 space-y-5">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between gap-6">
              ...
              {grammar.formula && (
                <div className="w-full md:w-auto min-w-[280px] bg-slate-50 border border-slate-200 rounded-lg p-4">
                  <h2 className="text-[10px] font-bold text-slate-400 uppercase mb-2 tracking-widest">
                    YAPI / FORMÜL
                  </h2>
          ...
          <div className="bg-[#FFFCF0] border border-[#F1E5BC] rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 divide-x divide-y divide-slate-100">
              {grammar.examples?.map((ex: any, i: number) => (
                <div key={i} className="p-5 hover:bg-slate-50/50 transition-colors group">
                  ...
                  <p className="text-[14px] text-slate-500 font-medium italic">{ex.tr}</p>
                </div>
              ))}
            </div>
          </div>
