...
export default function QuizHeader() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200 dark:border-gray-700 pb-4 mb-6 gap-4">
                ...
                <div className="flex items-center justify-between sm:justify-start gap-4">
                    ...
                    <button
                        ...
                        className={`sm:hidden relative inline-flex items-center w-14 h-7 rounded-full focus:outline-none flex-shrink-0 border-2 transition-opacity duration-0
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
                    ...
                    {ready && (canAccessUserQuiz ? (
                        <Link
                            href="/dashboard"
                            className="flex items-center justify-center gap-1.5 w-full sm:w-auto px-3 flex-1 sm:flex-none py-2 sm:py-1.5 rounded-md text-sm sm:text-xs font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 border border-blue-200 dark:border-blue-800 transition-colors"
                        >
                        ...
                        <Link
                            href="/"
                            className="flex items-center justify-center gap-1.5 w-full sm:w-auto px-3 flex-1 sm:flex-none py-2 sm:py-1.5 rounded-md text-sm sm:text-xs font-semibold text-slate-600 dark:text-gray-300 bg-slate-100 dark:bg-gray-800/50 hover:bg-slate-200 dark:hover:bg-gray-700 border border-slate-200 dark:border-gray-700 transition-colors"
                        >
                    ...
                    <button
                        onClick={toggleDarkMode}
                        className={`hidden sm:inline-flex relative items-center w-14 h-7 rounded-full focus:outline-none flex-shrink-0 border-2 transition-opacity duration-0
                                ${!mounted ? "opacity-0" : "opacity-100"}
                                ${darkMode
                                ? "bg-gray-800 border-gray-700 hover:bg-gray-750 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)]"
                                : "bg-slate-200 border-slate-300 hover:bg-slate-250 shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]"}`}
                    ...
                    <div className="flex w-full sm:w-auto justify-center bg-slate-200/50 dark:bg-gray-800/50 p-1 rounded-md gap-1 flex-shrink-0">
                        <button
                            onClick={() => setCurrentView("global")}
                            className={`flex flex-1 sm:flex-none items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded text-xs font-semibold transition-all
                                ${currentView === "global"
                        ...
                        <div className="relative group flex flex-1 sm:flex-none">
                            <button
                                ...
                                className={`w-full flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded text-xs font-semibold transition-all
                                    ${currentView === "user"
                                        ? "bg-white dark:bg-gray-700 text-slate-900 dark:text-white shadow-sm border border-slate-200 dark:border-gray-700"
                                        : "text-slate-600 dark:text-gray-400 hover:bg-slate-200 dark:hover:bg-gray-700"
                            ...
                            {!canAccessUserQuiz && (
                                <div className="absolute right-0 sm:left-1/2 sm:-translate-x-1/2 top-full mt-2 w-max max-w-[200px] px-2 py-1.5 bg-slate-800 dark:bg-gray-800 text-white text-[10px] font-medium rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 pointer-events-none shadow-lg">
